...
insert into ticket(duration,price,typeof_ticket,cityid) values ('End of section 2',175,'section 2',1)
insert into ticket(duration,price,typeof_ticket,cityid) values ('End of section 3',200,'section 3',1)
insert into ticket(duration,price,typeof_ticket,cityid) values ('End of section 4',250,'section 4',1)
insert into ticket(duration,price,typeof_ticket,cityid) values ('End of section 5',300,'section 5',1)
...
insert into transcity values('http://demdikk.com/senegal_dem_dikk/','Bus Senegal Dem Dikk','cityid')
insert into transcity values('http://edreams.com/flights/dakar-ziguinchor/DKR/ZIG','Avion','cityid')
insert into transcity values('http://edreams.com/flights/dakar-ziguinchor/DKR/ZIG','Avion','cityid')
insert into transcity values('http://edreams.com/flights/dakar-ziguinchor/DKR/ZIG','Avion','cityid')
